...
import com.qq.okhttp.builder.PostFileBuilder;
import com.qq.okhttp.builder.PostFormBuilder;
import com.qq.okhttp.builder.PostStringBuilder;
import com.qq.okhttp.callback.Callback;
import com.qq.okhttp.request.RequestCall;
import com.qq.okhttp.utils.Platform;
...
public class OkHttpUtils2 {
    ...
    private volatile static OkHttpUtils2 mInstance;
    ...
    public static OkHttpUtils2 initClient(OkHttpClient okHttpClient) {
        if (mInstance == null) {

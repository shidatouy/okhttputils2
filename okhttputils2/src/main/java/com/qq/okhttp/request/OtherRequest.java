...
import com.qq.okhttp.utils.Exceptions;
...
public class OtherRequest extends OkHttpRequest
{
    ...
    {
        if (method.equals(OkHttpUtils2.METHOD.PUT))
        {
            builder.put(requestBody);
        } else if (method.equals(OkHttpUtils2.METHOD.DELETE))
        {
            if (requestBody == null)
                builder.delete();
            else
                builder.delete(requestBody);
        } else if (method.equals(OkHttpUtils2.METHOD.HEAD))
        {
            builder.head();
        } else if (method.equals(OkHttpUtils2.METHOD.PATCH))
        {
